 ...
 * frame is 320 bytes. Its deepest linked path (file cleanup through FatFs and
 * asynchronous SDIO) sums to 1376 bytes before the context frame, so 432
 * words leave 96 bytes beyond that path and the port context.
