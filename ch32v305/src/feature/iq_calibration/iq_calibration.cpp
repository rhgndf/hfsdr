...
constexpr int16_t kPhaseMinCycles = -48;
constexpr int16_t kPhaseMaxCycles = 48;
...
static float s_baseline_irr_db = -99.0f;
static float s_current_irr_db = -99.0f;
static float s_best_irr_db = -99.0f;
