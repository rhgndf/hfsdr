...
# Title: HFSDR Basic Waterfall
# Description: HFSDR waterfall with UI-like IQ preprocessing
...
import basic_waterfall_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class basic_waterfall(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "HFSDR Basic Waterfall", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("HFSDR Basic Waterfall")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "basic_waterfall")
        ...
        self.qtgui_waterfall_sink_x_0.set_update_time(0.06)
        ...
        self.qtgui_waterfall_sink_x_0.set_intensity_range(-110, -55)
...
def main(top_block_cls=basic_waterfall, options=None):
