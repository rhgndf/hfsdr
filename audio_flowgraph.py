...
class audio_flowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "audio_flowgraph")
        ...
        self.blocks_multiply_const_vxx_0_1 = blocks.multiply_const_ff(1000)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.audio_source_0 = audio.source(samp_rate, "3- TinyUSB headset", True)
...
def main(top_block_cls=audio_flowgraph, options=None):
